...
internal static class HelperGenericAncillaryListsArrays
{
    ...
    internal static string[] GetCountryCodes()
    {
        ...
        {
            _ = LanguageTZ.DataReadCountryCodeDataFromWikipediaData();
        }
    ...
    /// <summary>
    /// Creates and returns a DataTable containing ISO 3166-1 country details, including country names, codes, and
    /// related metadata.
    /// </summary>
    /// <remarks>The returned DataTable columns correspond to the names defined in the
    ...
    internal static DataTable GetCountryDetailsToTable()
    {
        ...
        // as of 2026-01-03
        string CountryDataFromWikipedia =
            """
             Afghanistan[c]	AF	AFG	004	ISO 3166-2:AF	Yes
             ...
             Bonaire, Sint Eustatius and Saba[d]	BQ	BES	535	ISO 3166-2:BQ	No
             ...
             China[c]	CN	CHN	156	ISO 3166-2:CN	Yes
             ...
             Cyprus[c]	CY	CYP	196	ISO 3166-2:CY	Yes
             ...
             Falkland Islands (Malvinas)[c]	FK	FLK	238	ISO 3166-2:FK	No
             ...
             Palestine, State of[c]	PS	PSE	275	ISO 3166-2:PS	No
             ...
             Taiwan, Province of China[c]	TW	TWN	158	ISO 3166-2:TW	No
             ...
             Western Sahara[c]	EH	ESH	732	ISO 3166-2:EH	No
        ...
        foreach (string name in Enum.GetNames(typeof(LanguageMappingQueryOrReturnWhat)))
        {
            _ = dataTable.Columns.Add(name);
        }
        dataTable.Columns["Numeric"].DataType = typeof(int);

        foreach (string line in CountryDataFromWikipedia.Split(
            ...
            StringSplitOptions.None))
        {
            ...
            for (int i = 0; i < array.Length; i++)
            {
                if (i < dataTable.Columns.Count)
                {
                    ...
                    dataRow[i] = dataTable.Columns[i].ColumnName == "Country"
                        ? value.LastIndexOf('[') > -1 ? value.Substring(0, value.LastIndexOf('[')).Trim() : value
                        : dataTable.Columns[i].ColumnName == "Numeric" ? int.Parse(value) : value;
                }
            }
