...
namespace GeoTagNinja.Helpers.Generic;
...
internal static class HelperGenericAppStartup
{
    ...
    public static Task AppStartupCreateDatabaseFile()
    {
        ...
        try
        {
            ...
            DatabaseAndStartup.DataCreateSQLiteDB();
        }
        catch (Exception ex)
        {
    ...
    public static Task AppStartupWriteDefaultSettings()
    {
        ...
        try
        {
            ...
            DatabaseAndStartup.DataWriteSQLiteSettingsDefaultSettings();
        }
        catch (Exception ex)
        {
            Themer.ShowMessageBox(
    ...
    public static Task AppStartupReadSQLiteTables()
    {
        try
        {
            HelperVariables.DtHelperDataApplicationSettings =
                DatabaseAndStartup.DataReadSQLiteTable(tableName: "settings");
            ...
            HelperVariables.DtHelperDataApplicationLayout =
                DatabaseAndStartup.DataReadSQLiteTable(tableName: "appLayout");
        }
        catch
        {
            //
    ...
    public static Task AppStartupReadAppLanguage()
    {
        ...
        try
        {
            string lang = ApplicationSettings.DataReadSQLiteSettings(
    ...
    {
        HelperVariables.DtCustomCityLogic = CustomCityAllocationRules.DataReadSQLiteCustomCityAllocationLogic();
    ...
    public static Task AppStartupReadAPILanguage()
    {
        ...
        try
        {
            TryUseGeoNamesLanguage = ApplicationSettings.DataReadSQLiteSettings(
                                               ...
                                               bool actuallyRunningAtStartup)
    {
        ...
        if (actuallyRunningAtStartup)
        {
            ...
            HelperVariables.UOMAbbreviated = DatabaseAndStartup.GetUnitOfMeasureAbbreviated();
        }
                                          ...
                                          FieldInfo field)
    {
            ...
            map.TryGetValue(key: field.Name, value: out string controlId))
        {
            ...
            {
                field.SetValue(obj: null, value: ApplicationSettings.DataReadSQLiteSettings(
                                        ...
                                        bool defaultValue)
    {
            ...
            map.TryGetValue(key: field.Name, value: out string controlId))
        {
            ...
            {
                field.SetValue(obj: null, value: ApplicationSettings.DataReadCheckBoxSettingTrueOrFalse(dataTable: HelperVariables.DtHelperDataApplicationSettings,
                    settingTabPage: tab,
                    settingId: controlId,
                                       ...
                                       FieldInfo field)
    {
            ...
            map.TryGetValue(key: field.Name, value: out string controlId))
        {
            ...
            {
                field.SetValue(obj: null, value: ApplicationSettings.DataReadIntSetting(
                    dataTable: HelperVariables.DtHelperDataApplicationSettings, settingTabPage: tab,
                    settingId: controlId));
            }
            else
                                         ...
                                         FieldInfo field)
    {
        ...
        {
            string selected = ApplicationSettings.DataReadRadioButtonSettingTrueOrFalse(
                dataTable: HelperVariables.DtHelperDataApplicationSettings, settingTabPage: tab,
    ...
    {
        _ = bool.TryParse(value: ApplicationSettings.DataReadSQLiteSettings(
            dataTable: HelperVariables.DtHelperDataApplicationSettings,
            settingTabPage: "tpg_Application",
        ...
        {
            string replaceEmpty = ApplicationSettings.DataReadSQLiteSettings(
                dataTable: HelperVariables.DtHelperDataApplicationSettings,
                settingTabPage: "tpg_Application",
    ...
    {
        string choiceCountValue = ApplicationSettings.DataReadSQLiteSettings(
                                      dataTable: HelperVariables.DtHelperDataApplicationSettings,
                                      settingTabPage: "tpg_Application",
        ...
        string radiusValue = ApplicationSettings.DataReadSQLiteSettings(
                                 dataTable: HelperVariables.DtHelperDataApplicationSettings,
                                 settingTabPage: "tpg_Application",
    ...
    public static void AppStartupLoadFavourites(bool clearDropDown = true)
    {
        ...
        Favourites.DataReadSQLiteFavourites();
    ...
    public static void AppSetupInitialiseStartupFolder(ToolStripTextBox toolStripTextBox)
    {
        ...
        else
        {
            try
            {
                bool useLastUsedFolder = ApplicationSettings.DataReadCheckBoxSettingTrueOrFalse(
                    dataTable: HelperVariables.DtHelperDataApplicationSettings,
                    settingTabPage: "tpg_Application",
                ...
                {
                    startupFolder = ApplicationSettings.DataReadSQLiteSettings(
                        dataTable: HelperVariables.DtHelperDataApplicationSettings,
                        settingTabPage: "tpg_Application",
