...
namespace GeoTagNinja
{
    ...
    public partial class GTNReleaseAPIResponse
    {
        public static GTNReleaseAPIResponse[] FromJson(string json) => JsonConvert.DeserializeObject<GTNReleaseAPIResponse[]>(json, GeoTagNinja.Helpers.API.Converter.Settings);
    }
